...
you can see that \(w_0\) is still oscillating around the minimum, but
the cost is decreasing with every iteration rather than increasing. Note
above that \texttt{dj\_dw{[}0{]}} changes sign with each iteration as
...
\end{tcolorbox}
    ...
    On the left, you see that cost is decreasing as it should. On the right,
you can see that \(w_0\) is approaching the minimum without
oscillations. \texttt{dj\_w0} is negative throughout the run. This
solution will also converge.
